...
def call_model_by_batch(comments_batched: pd.DataFrame, prompt_type: str) -> str:
    prompt_types = {
        "user": """You will receive multiple comments from a single user about different board games.
        These comments are in French and are separated by newlines.
        Your goal is to summarize the user’s overall preferences by identifying what they liked and disliked
        across all the games.""",
        "game": """You will receive multiple comments from different users about a single board game.
        These comments are in French and are separated by newlines.
        ...
        comments based on similar opinions. I will give you comments from different users about the board game
        (comments by different usersare separated by newlines). Based on these comments, generate a new user
        comment that: feels natural and realistic, reflects the general sentiment and themes from the given comments and
        introduces slight variations in style and phrasing to sound unique. Here are users comments : """,
        """descriptions""": """You will receive multiple board game descriptions in French.
        Each description is separated by a newline.
        Your task is to summarize these descriptions and to identify key mechanics, target audience, qualit,
        complexity etc.
        The goal is to find what is in common for all these games. Here are the descriptions: """,
        "desc_summary": """You will receive descriptions in French on 10 board games.
        Each description is separated by a newline.
        ...
        mais il doit inclure les points importants (bien décrire le jeu). Tu ne dois pas ajouter des explications,
        donne juste le commentaire généré à partir des phrases.
        Voici des phrases : """,
    }
